...
export default function DisclaimerPage() {
  return (
    <SiteShell>
      <div className="desktop-secondary-page desktop-reading-page desktop-legal-page desktop-disclaimer-page space-y-8 lg:space-y-10">
      <PageSectionTitle
        eyebrow="Disclaimer"
        title="免责声明与使用边界"
      ...
      <section className="grid gap-5">
        {[
          ...
          ['申请管理建议', '全部申请中的截止提醒、材料清单和申请状态用于辅助管理，不构成录取承诺、升学保证、法律建议或任何确定性结论。'],
