...
const staticRoutes = ['/', '/notices', '/colleges', '/resources', '/offers', '/ai', '/me', '/about', '/terms', '/privacy', '/disclaimer'];
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const noticeEntries = baseNoticeProjects.slice(0, 1000).map((project) => ({
