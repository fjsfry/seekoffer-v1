...
const resourceLogoSources = {
  ...
  'xmind.app': 'https://assets.xmind.net/static/logos/logo-gradient-rounded.png',
  'docs.qq.com': 'https://docs.gtimg.com/docs-design-resources/pc/svg/Logo-efe5613b73.svg',
